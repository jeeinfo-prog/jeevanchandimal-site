...
/**
 * ✅ NEW: Return the raw Readable stream (Body) for streaming to the client.
 * This is what your /api/download.js expects as `getObjectStream`.
 */
