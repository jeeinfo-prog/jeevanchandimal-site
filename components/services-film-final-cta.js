...
const ServicesFilmFinalCTA = (props) => {
  return (
    <>
      <section className={`sffcta-wrap thq-section-padding ${props.rootClassName || ''}`}>
        <div className="sffcta-max thq-section-max-width">
          <div className="sffcta-card">
            <div className="sffcta-bg" aria-hidden="true">
              <div className="sffcta-vignette" />
              <div className="sffcta-grain" />
            </div>

            <div className="sffcta-inner">
              <div className="sffcta-kickerRow">
                <span className="sffcta-kicker">FINAL CTA</span>
                <span className="sffcta-line" />
              </div>

              <h2 className="thq-heading-2 sffcta-title">
                {props.heading1 ?? (
                  <Fragment>
              ...
              <p className="thq-body-large sffcta-copy">
                {props.content1 ?? (
                  <Fragment>
              ...
              <div className="sffcta-actions">
                ...
                {props.secondaryHref ? (
                  <Link href={props.secondaryHref} legacyBehavior>
                    <a className="btnGhost" aria-label="View Film Work">
                      <span className="btnText">
              ...
              <div className="sffcta-divider" aria-hidden="true" />
              <div className="sffcta-meta thq-body-small">
                Story • Depth • Craft • Presence
              </div>
            </div>
          </div>
        </div>
