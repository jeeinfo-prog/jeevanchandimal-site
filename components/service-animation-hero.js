  ...
  return (
    <>
      <div className={`hero ${props.rootClassName}`}>
        ...
        <img
          alt={props.image1Alt}
          src="/services/animation/heroani.jpg"
          className="bg"
          loading="eager"
        />
        ...
        <div className="content">
          ...
          <p className="desc">
            {props.content1 ?? (
              <Fragment>
                <span className="t">
                  Animation and movement used to support story — never distract from it.
                </span>
              </Fragment>
            )}
          </p>
            ...
            <Link href="/work-animation" legacyBehavior>
              <a className="btnPrimary">
                <span className="btnText">
                  {props.primaryLabel ?? (
                    <Fragment>
                      <span className="t">View Motion Work</span>
                    </Fragment>
                  )}
                </span>
...
ServiceAnimationHero.defaultProps = {
  rootClassName: '',
  image1Alt: 'Animation motion background',
  heading1: undefined,
  content1: undefined,
