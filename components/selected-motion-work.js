...
const SelectedMotionWork = (props) => {
  const frames = useMemo(() => {
    // ✅ defaults to local public/services/animation/sani-xx.jpg
    const list = [
      {
        src: props.image1Src || '/services/animation/sani-01.jpg',
        alt: props.image1Alt || 'Selected motion frame 01',
      },
      {
        src: props.image2Src || '/services/animation/sani-02.jpg',
        alt: props.image2Alt || 'Selected motion frame 02',
      },
      {
        src: props.image3Src || '/services/animation/sani-03.jpg',
        alt: props.image3Alt || 'Selected motion frame 03',
      },
      {
        src: props.image4Src || '/services/animation/sani-04.jpg',
        alt: props.image4Alt || 'Selected motion frame 04',
      },
      {
        src: props.image5Src || '/services/animation/sani-05.jpg',
        alt: props.image5Alt || 'Selected motion frame 05',
      },
      {
        src: props.image6Src || '/services/animation/sani-06.jpg',
        alt: props.image6Alt || 'Selected motion frame 06',
      },
      {
        src: props.image7Src || '/services/animation/sani-07.jpg',
        alt: props.image7Alt || 'Selected motion frame 07',
      },
    ].filter((x) => x?.src)
  ...
  const hero =
    props.heroImageSrc || frames?.[0]?.src || '/services/animation/sani-01.jpg'

  const headingNode =
    props.heading1 ?? (
      <Fragment>
        <span className="titleText">Selected Motion Work</span>
      </Fragment>
    )
  ...
  const descNode =
    props.content1 ?? (
      <Fragment>
        <span>
          A distilled set of frames — rhythm first. If you need a full deck,
          ...
          <div className="heroCard">
            ...
            <div className="heroInner">
              <div className="kickerRow">
                ...
                <span className="kickerSub">Motion · Animation · Design</span>
              </div>
              ...
              <div className="micro thq-body-small">
                Clarity • Rhythm • Cinematic restraint
              </div>
            </div>
          </div>
          ...
          <div className="lbInner" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="lbMeta">
              ...
              <span className="lbAlt">
                {frames[activeIdx].alt || 'Selected frame'}
              </span>
            </div>
          </div>
        </div>
...
SelectedMotionWork.defaultProps = {
  ...
  heroImageSrc: '/services/animation/sani-01.jpg',
  ...
  image1Alt: 'Selected motion frame 01',
  image2Alt: 'Selected motion frame 02',
  image3Alt: 'Selected motion frame 03',
  image4Alt: 'Selected motion frame 04',
  image5Alt: 'Selected motion frame 05',
  image6Alt: 'Selected motion frame 06',
  image7Alt: 'Selected motion frame 07',
}
