...
const WorkFilmMusicVideo = (props) => {
  // ✅ hero image (defaults to feature1)
  const hero = props.heroImageSrc || props.feature1ImageSrc || '/work/film/mv-01.jpg'

  const headingNode =
    props.heading1 ?? (
      <Fragment>
        <span className="titleText">Music Video</span>
      </Fragment>
    )
  ...
  const copyNode =
    props.content1 ?? (
      <Fragment>
        <span>
          Music-driven visual pieces where rhythm, movement, and image work together
          as a unified experience. Each video is shaped to support the sound while
          maintaining cinematic structure and restraint.
        </span>
      </Fragment>
    )
        ...
        <div className="shell thq-section-max-width">
          ...
          <div className="heroCard">
            ...
            <div className="heroInner">
              ...
              <div className="micro thq-body-small">
                Tempo-led visuals • Cinematic motion • Premium finish
              </div>
            </div>
          </div>
          ...
          <div className="grid">
            <MVCard
              ...
              fallbackTitle="mv-01"
              fallbackDesc="Music-driven storytelling with cinematic pacing."
            />
            <MVCard
              idx="02"
              ...
              fallbackTitle="mv-02"
              fallbackDesc="Movement + texture designed to serve the sound."
            />
            <MVCard
              idx="03"
              ...
              fallbackTitle="mv-03"
              fallbackDesc="Minimal narrative with strong visual continuity."
            />
          </div>
        </div>
      </section>
...
function MVCard({ idx, href, img, alt, title, desc, fallbackTitle, fallbackDesc }) {
      ...
      <div className="media">
        ...
        <div className="frame">
          ...
          <div className="capTop">
            ...
            <span className="capMeta">{idx}</span>
          </div>
        </div>
      </div>

      <div className="body">
        <h3 className="h thq-heading-3">{cardTitleNode}</h3>
        <p className="p thq-body-small">{cardDescNode}</p>
  ...
  return (
    <>
      <article className="mvCard">
        {href && href !== '#' ? (
          <Link href={href} legacyBehavior>
            <a className="link" aria-label={`Open Music Video ${idx}`}>
              {content}
            </a>
          </Link>
        ) : (
          <div className="link" aria-label={`Music Video ${idx}`}>
            {content}
          </div>
        )}
      </article>
...
WorkFilmMusicVideo.defaultProps = {
  ...
  heroImageSrc: '/work/film/mv-01.jpg',
