...
const Work3DAnimation = (props) => {
  return (
    <>
      <section className={`wa3dSection thq-section-padding ${props.rootClassName || ''}`}>
          ...
          <header className="titleRow">
            ...
            <p className="thq-body-large desc">
              {props.sectionDescription ?? (
                <Fragment>
                  <span>
                    Three-dimensional motion work focused on spatial clarity and visual cohesion.
                    These projects emphasize lighting, form, and controlled movement over spectacle.
                  </span>
                </Fragment>
              )}
            </p>
              ...
              <div className="cardBody">
                ...
                <span className="thq-body-small cardText">
                  {props.feature1Description ?? (
                    <Fragment>
                      <span>A cinematic approach to light, surface, and shape—built for mood.</span>
                    </Fragment>
                  )}
                </span>
              </div>
              ...
              <div className="cardBody">
                ...
                <span className="thq-body-small cardText">
                  {props.feature2Description ?? (
                    <Fragment>
                      <span>Readable depth and composition—clean silhouettes and intentional space.</span>
                    </Fragment>
                  )}
                </span>
              </div>
              ...
              <div className="cardBody">
                ...
                <span className="thq-body-small cardText">
                  {props.feature3Description ?? (
                    <Fragment>
                      <span>Motion that supports story beats—restraint over spectacle.</span>
                    </Fragment>
                  )}
                </span>
              </div>
...
Work3DAnimation.defaultProps = {
  ...
  feature1ImageAlt: 'Lighting & Form',
  feature1ImageSrc: '/work/animation/wa3d-01.jpg',

  feature2Title: undefined,
  feature2Description: undefined,
  feature2ImageAlt: 'Spatial Clarity',
  feature2ImageSrc: '/work/animation/wa3d-02.jpg',

  feature3Title: undefined,
  feature3Description: undefined,
  feature3ImageAlt: 'Controlled Movement',
  feature3ImageSrc: '/work/animation/wa3d-03.jpg',
