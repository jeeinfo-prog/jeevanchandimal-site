...
const Work3DAnimation = (props) => {
  return (
    <>
      <section
        className={`wa3dSection thq-section-padding ${props.rootClassName || ''}`}
      >
            ...
            <div className="titleInner">
              ...
              <p className="thq-body-large desc">
                {props.sectionDescription ?? (
                  <Fragment>
                    <span>
                      Three-dimensional motion work focused on spatial clarity
                      and visual cohesion. These projects emphasize lighting,
                      form, and controlled movement over spectacle.
                    </span>
                  </Fragment>
                )}
              </p>
              ...
              <div className="cardBody">
                ...
                <span className="thq-body-small cardText">
                  {props.feature1Description ?? (
                    <Fragment>
                      <span>
                        A cinematic approach to light, surface, and shape—built
                        for mood.
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="cardBody">
                ...
                <span className="thq-body-small cardText">
                  {props.feature2Description ?? (
                    <Fragment>
                      <span>
                        Readable depth and composition—clean silhouettes and
                        intentional space.
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="cardBody">
                ...
                <span className="thq-body-small cardText">
                  {props.feature3Description ?? (
                    <Fragment>
                      <span>
                        Motion that supports story beats—restraint over
                        spectacle.
                      </span>
                    </Fragment>
                  )}
