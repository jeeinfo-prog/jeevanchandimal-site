// pages/services-film-production.js
...
export default function ServicesFilmProduction() {
  return (
    <>
      <div className="services-film-production-container">
        <Head>
          <title>Services-Film-Production - Jeevan Chandimal | Filmmaker & Visual Storyteller</title>
          <meta
            name="description"
          ...
          />
          <link rel="canonical" href="https://firm-these-stork-6nk3lv.teleporthq.app/services-film-production" />
        </Head>
        ...
        <JeevanChandimalNavi
          ...
          text171={
            <Fragment>
              <span className="services-film-production-text22">Film Production</span>
            </Fragment>
          }
          text181={
            <Fragment>
              <span className="services-film-production-text23">Audio Production</span>
            </Fragment>
          }
          text191={
            <Fragment>
              <span className="services-film-production-text24">Photography</span>
            </Fragment>
          }
          text192={
            <Fragment>
              <span className="services-film-production-text25">Animation &amp; Motion</span>
            </Fragment>
          }
          text1911={
            <Fragment>
              <span className="services-film-production-text26">Photography</span>
            </Fragment>
          }
        ...
        <ServiceFilmHero
          action3={
            <Fragment>
              <span className="services-film-production-text27">Create Together</span>
            </Fragment>
          }
          content1={
            <Fragment>
              <span className="services-film-production-text28">
                Film-led visual production where image, motion, and sound work as one - from concept to final delivery.
              </span>
            </Fragment>
          }
          heading1={
        ...
        <IntroductionFilmServices
          feature1Title={
            <Fragment>
              <span className="services-film-production-text30">Introduction</span>
            </Fragment>
          }
          feature1Description={
            <Fragment>
              <span className="services-film-production-text31">
                <span>
                  I offer end-to-end film production shaped by cinematic intent. Every project is approached as a
                  complete visual experience - carefully composed, emotionally grounded, and refined through sound,
                  movement, and pacing.
                </span>
                <br />
                <span>
                  From early concept development to final cut, I work across the full filmmaking process to create
                  films that feel intentional, immersive, and lasting.
                </span>
              </span>
            </Fragment>
          }
        ...
        <SelectedFilmWork
          content1={
            <Fragment>
              <span className="services-film-production-text35">
                A curated selection of commercial, documentary, and narrative projects — each built with atmosphere,
                clarity, and purpose.
              </span>
            </Fragment>
          }
          heading1={
            <Fragment>
              <span className="services-film-production-text36">Sample Projects</span>
            </Fragment>
          }
        ...
        <WhatIDoFilmServices
          ...
          feature1Title={
            <Fragment>
              <span className="services-film-production-text38">Commercials &amp; Brand Films</span>
            </Fragment>
          }
          feature2Title={
            <Fragment>
              <span className="services-film-production-text39">Documentary Films</span>
            </Fragment>
          }
          feature3Title={
            <Fragment>
              <span className="services-film-production-text40">Short Films &amp; Visual Stories</span>
            </Fragment>
          }
          feature4Title={
            <Fragment>
              <span className="services-film-production-text41">Post-Production &amp; Finishing</span>
            </Fragment>
          }
          feature1Button={
            <Fragment>
              <span className="services-film-production-text42">Learn More</span>
            </Fragment>
          }
          feature2Button={
            <Fragment>
              <span className="services-film-production-text43">Discover More</span>
            </Fragment>
          }
          feature3Button={
            <Fragment>
              <span className="services-film-production-text44">Explore Now</span>
            </Fragment>
          }
          feature4Button={
            <Fragment>
              <span className="services-film-production-text45">View Portfolio</span>
            </Fragment>
          }
          feature1Description={
            <Fragment>
        ...
        <HowIApproachFilm
          feature1Title={
            <Fragment>
              <span className="services-film-production-text50">How I Approach Film</span>
            </Fragment>
          }
          feature1Description={
            <Fragment>
              <span className="services-film-production-text51">
                <span>
                  Story comes first. Before cameras, equipment, or timelines, the focus is always on meaning, mood,
                  and visual language.
                </span>
                <br />
                <span>
                  I treat film as a layered experience — where composition, movement, sound, and silence work
                  together. Every choice is made to serve the story, not the spectacle.
                </span>
              </span>
            </Fragment>
          }
        ...
        <ServiceFilmProcess
          feature3Title={
            <Fragment>
              <span className="services-film-production-text55">Visual Direction</span>
            </Fragment>
          }
          ...
          feature3Title1={
            <Fragment>
              <span className="services-film-production-text57">Production &amp; Post</span>
            </Fragment>
          }
          feature1Title11={
            <Fragment>
              <span className="services-film-production-text58">Discovery &amp; Concept</span>
            </Fragment>
          }
          feature3Title11={
            <Fragment>
              <span className="services-film-production-text59">Final Delivery</span>
            </Fragment>
          }
          feature3Description={
            <Fragment>
          ...
          feature1Description2={
            <Fragment>
              <span className="services-film-production-text61">
                Understanding the idea, intention, and emotional direction of the project.
              </span>
            </Fragment>
          }
          feature3Description1={
            <Fragment>
              <span className="services-film-production-text62">
                Careful execution through filming, editing, sound design, and grading.
              </span>
            </Fragment>
          }
          feature3Description11={
            <Fragment>
              <span className="services-film-production-text63">
                A refined, complete film ready for its intended audience and platform.
              </span>
            </Fragment>
          }
        />
        ...
        <WhoItsForFilm
          ...
          heading1={
            <Fragment>
              <span className="services-film-production-text65">Who It’s For</span>
            </Fragment>
          }
        />
        ...
        <ServicesFilmFinalCTA
          action2={
            <Fragment>
              <span className="services-film-production-text66">Create Together</span>
            </Fragment>
          }
          content1={
            <Fragment>
          ...
          heading1={
            <Fragment>
              <span className="services-film-production-text68">Have a project in mind?</span>
            </Fragment>
          }
        />
        ...
        <JeevanChandimalNewFooter
          ...
          link51={
            <Fragment>
              <span className="services-film-production-text71">Membership</span>
            </Fragment>
          }
          text16={
            <Fragment>
          ...
          text171={
            <Fragment>
              <span className="services-film-production-text78">Film Production</span>
            </Fragment>
          }
          text181={
            <Fragment>
              <span className="services-film-production-text79">Audio Production</span>
            </Fragment>
          }
          text191={
            <Fragment>
              <span className="services-film-production-text80">Photography</span>
            </Fragment>
          }
          text192={
            <Fragment>
              <span className="services-film-production-text81">Animation &amp; Motion</span>
            </Fragment>
          }
          link5111={
            <Fragment>
          ...
          text1911={
            <Fragment>
              <span className="services-film-production-text83">Photography</span>
            </Fragment>
          }
          termsLink={
            <Fragment>
              <span className="services-film-production-text84">Terms &amp; Conditions</span>
            </Fragment>
          }
          cookiesLink={
            <Fragment>
              <span className="services-film-production-text85">Cookies Policy</span>
            </Fragment>
          }
          privacyLink={
            <Fragment>
              <span className="services-film-production-text86">Privacy Policy</span>
            </Fragment>
          }
