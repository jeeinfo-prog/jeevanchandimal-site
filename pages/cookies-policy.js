  ...
  return (
    <main className="legal-page">
      <div className="legal-wrap">
        ...
        <ul>
          <li><strong>Essential Cookies</strong> — required for core functionality (navigation, secure areas, cart/checkout)</li>
          <li><strong>Performance &amp; Analytics Cookies</strong> — help us understand usage so we can improve the website</li>
          <li><strong>Functional Cookies</strong> — remember preferences like language or region</li>
        </ul>
