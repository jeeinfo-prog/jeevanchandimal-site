  ...
  return (
    <>
      ...
      <main className="wrap">
        ...
        <p>
          At <strong>JeevanChandimal.com</strong>, we are committed to protecting your privacy
          and safeguarding your personal information. This Privacy Policy explains how we
          collect, use, and protect your data when you visit our website or purchase digital
          photography and licensing services from us.
        </p>
        ...
        <ul>
          <li>
            Personal information such as your name and email address provided during checkout
            or when contacting us.
          </li>
          <li>
            Payment details required to process your order. Payments are securely handled by
        ...
        <p>
          ...
          trusted third parties who help us operate our business, including:
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Email delivery providers (e.g., Resend)</strong> – to send receipts and
            download links
          </li>
          <li>
            <strong>Cloud storage and database providers (e.g., Supabase, Cloudflare R2)</strong>
            – to store product files and order records securely
          </li>
        </ul>

        <p>
          These providers are required to protect your data and use it only for the services
          they provide.
        </p>
        ...
        <p>
          ...
          analyze website traffic, and understand user behavior. You can disable cookies in
          your browser settings, but some features of the website may not function properly.
        </p>

        <h2>Data Retention</h2>
        <p>
          We retain your order and contact information only as long as necessary to provide
          your digital downloads, maintain transaction records, and comply with legal
          obligations.
        </p>
