...
export default function ServicesPhotography() {
  ...
  return (
    <>
      <Head>
        <title>Services-Photography - Jeevan Chandimal | Filmmaker & Visual Storyteller</title>
        <meta
          name="description"
            ...
            <div className="block">
              <ServicePhotographyHero
                ...
                content1={
                  <Fragment>
                    <span className="t">
                      Photography approached as storytelling — crafted with cinematic intent and
                      emotional clarity.
                    </span>
                  </Fragment>
                }
            ...
            <IntroductionPhotographyServices
              ...
              feature1Description={
                <Fragment>
                  <span className="t">
                    <span>
                      Photography is where my visual language began. I approach still images the
                      same way I approach film — with attention to light, composition, and the
                      feeling a moment carries.
                    </span>
                    <br />
                    <span>
                      Each photograph is created to stand on its own, while also fitting naturally
                      into larger visual narratives for editorial, commercial, and artistic use.
                    </span>
                  </span>
                </Fragment>
              }
          ...
          <section className="section">
            <SelectedPhotography
              content1={
                <Fragment>
                  <span className="t">
                    A curated selection of editorial, cinematic, and fine-art photography — focused
                    on atmosphere, texture, and detail.
                  </span>
                </Fragment>
              }
              heading1={
          ...
          <section className="section">
            <WhatIDoPhotographyServices
              ...
              feature2Description={
                <Fragment>
                  <span className="t">
                    Quiet, patient observations of the natural world, captured with respect and
                    realism.
                  </span>
                </Fragment>
              }
              ...
              feature4Description={
                <Fragment>
                  <span className="t">Timeless compositions focused on light, form, and emotion.</span>
                </Fragment>
              }
            />
          </section>
            ...
            <HowIApproachPhotography
              ...
              feature1Description={
                <Fragment>
                  <span className="t">
                    <span>
                      I look for moments that feel honest and unforced. Light, timing, and stillness
                      matter more than spectacle.
                    </span>
                    <br />
                    <span>
                      Whether working in controlled environments or in the field, the goal is always
                      the same — to create images that feel considered, immersive, and lasting.
                    </span>
                  </span>
                </Fragment>
              }
          ...
          <section className="section">
            <WhoItsForPhotography
              content1={
                <Fragment>
                  <span className="t">
                    I work with brands, agencies, filmmakers, and individuals who value craft,
                    atmosphere, and intentional storytelling — and who see film as more than just
                    content.
                  </span>
                </Fragment>
              }
